...
def get_protected_values(project_name, sample_id_int, local_name, parent, log):
    ...
    startover_dic = {"allele_nr": allele_nr,
                     ...
                     "customer": customer,
                     "ena_submission_id": ena_submission_id if ena_submission_id != 'None' else None,
                     "ena_acception_date": mark_as_outdated(ena_acception_date),
                     "ena_accession_nr": ena_accession_nr if ena_accession_nr != 'None' else None,
                     "ipd_submission_id": mark_as_outdated(ipd_submission_id),
