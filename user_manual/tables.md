...
| 2 | CUSTOMER | TEXT | customer who sent the sample (optional) | no |
...
| 4 | CELL\_LINE | TEXT | cell line of this target allele (must be unique; used to identify the allele to outsiders like ENA and IPD) | **yes** |
| 5 | LOCAL\_NAME | TEXT | an automatically generated unique ID for this target allele based on its internal or external sample ID | no |
...
| 0 | SAMPLE\_ID\_INT | TEXT | internal sample ID of the sample | no |
| 1 | ALLELE\_NR | INT | number of this target allele within this sample | no |
| 2 | CELL\_LINE | TEXT |  cell line of this target allele (must be unique; used to identify the allele to outsiders like ENA and IPD) | **yes** |
...
| 5 | RAW\_FILE | TEXT | name of the renamed raw file uploaded to TypeLoader (TypeLoader only stored the renamed file, not the original file name) | no |
