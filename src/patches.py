...
def change_pk_of_ALLELES(conn, cursor, log):
    ...
    q1_new_table = """CREATE TABLE ALLELES_NEW 
                (SAMPLE_ID_INT TEXT , ALLELE_NR INT , PROJECT_NAME TEXT , PROJECT_NR INT , 
                LOCAL_NAME TEXT PRIMARY KEY, GENE TEXT , GOAL TEXT , ALLELE_STATUS TEXT , 
                UPLOAD_DATE TEXT, DETECTION_DATE TEXT, ORIG_ALLELE1 TEXT , 
                ...
                IPD_RELEASE TEXT, CELL_LINE_OLD TEXT)
                """
    cursor.execute(q1_new_table)
    q2_copy_data = """
        INSERT INTO ALLELES_NEW 
            (SAMPLE_ID_INT, ALLELE_NR, PROJECT_NAME, PROJECT_NR,
            LOCAL_NAME, GENE, GOAL, ALLELE_STATUS, upload_date, detection_date, 
